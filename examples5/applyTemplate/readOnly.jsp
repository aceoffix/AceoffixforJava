<%@ page language="java" 
	import="java.util.*,com.acesoft.aceoffix.*,java.sql.*,java.io.*,javax.servlet.*,javax.servlet.http.*" 
	pageEncoding="UTF-8"%>
...
<%
	...
	aceCtrl.setCaption(fileName);			
	aceCtrl.addCustomToolButton("Save as", "ShowDialog1()", 5);
    aceCtrl.addCustomToolButton("Page Setup", "ShowDialog2()", 0);
    aceCtrl.addCustomToolButton("Print", "ShowDialog3()", 6);
    aceCtrl.addCustomToolButton("Full-screen Switch", "IsFullScreen()", 4);
			
	aceCtrl.setMenubar(false);
	aceCtrl.setOfficeToolbars(false);
	
	aceCtrl.openDocument("doc/"+fileName, OpenModeType.docReadOnly, "Tom");					  
%>
