<%@ page language="java" import="java.util.*,java.awt.*"
	pageEncoding="UTF-8"%>
<%@page
	import="com.acesoft.aceoffix.*, com.acesoft.aceoffix.wordwriter.*"%>
<%
	AceoffixCtrl aceCtrl = new AceoffixCtrl(request);
	aceCtrl.setServerPage("../server.ace");//Required
	WordDocument doc = new WordDocument();
	DataRegion dataReg = doc.openDataRegion("test");
	...
	aceCtrl.openDocument("doc/introduce.doc", OpenModeType.docSubmitForm, "Tom");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>How to capture the click event in DataRegion</em></strong></span></div>
        <div class="right">
...
<script type="text/javascript">
	...
	function OnWordDataRegionClick(Name, Value, Left, Bottom) {
        ...
        if (Name == "ACE_test") {
            ...
            var strRet = document.getElementById("AceoffixCtrl1").ShowHtmlModalDialog("selectDept.htm?id=11", Value, "left=" + Left + "px;top=" + Bottom + "px;width=400px;height=200px;frame=no;");
