...
<%
	...
	aceCtrl.addCustomToolButton("Merge Right","mergeCellRight()",3);
	aceCtrl.addCustomToolButton("Merge Down","mergeCellDown()",3);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Merge the cells of table in Word document</em></strong></span></div>
