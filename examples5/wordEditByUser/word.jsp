...
WordDocument doc=new WordDocument();
	DataRegion data1=doc.openDataRegion("Paragraph1");
	data1.setValue("[word]doc/paragraph1.doc[/word]");
	data1.setSubmitAsFile(true);
	DataRegion data2=doc.openDataRegion("Paragraph2");
	data2.setValue("[word]doc/paragraph2.doc[/word]");
	data2.setSubmitAsFile(true);
	DataRegion data3=doc.openDataRegion("Paragraph3");
	data3.setValue("[word]doc/paragraph3.doc[/word]");
	if(userName.equals("Tom")){
		data1.setEditing(true);
		data2.setEditing(false);
		data3.setEditing(false);
	}else{
	data1.setEditing(false);
		data2.setEditing(true);
		data3.setEditing(false);
	}
...
aceCtrl1.setSaveDataPage("saveworddata.jsp?userName="+ userName);
aceCtrl1.openDocument("doc/merge.doc", OpenModeType.docSubmitForm, "John Scott");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Different users can simultaneously modify different regions in one Word document</em></strong></span></div>
        <div class="right">
