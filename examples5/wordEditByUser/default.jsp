...
<form id="form1"  action="word.jsp"> 
    ...
    <input type="button"  value="Open File" onclick="javascript:AceBrowser.openWindowModeless('word.jsp?userName='+form1.userName.value,'width=1200px;height=800px;');" /><br /><br />
