...
<%
	...
	String filePath = request.getSession().getServletContext().getRealPath("openFromDisk/doc/introduce.doc");
	...
	aceCtrl.openDocument(filePath,OpenModeType.docNormalEdit,"Tom");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Open the Office document from server disk path</em></strong></span></div>
        <div class="right">
