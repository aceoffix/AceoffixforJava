...
DataRegion dataRegion1 = wd.openDataRegion("Paragraph1");
dataRegion1.setSubmitAsFile(true);
dataRegion1.setEditing(true);
DataRegion dataRegion2 = wd.openDataRegion("Paragraph2");
dataRegion2.setSubmitAsFile(true);
dataRegion2.setEditing(true);
DataRegion dataRegion3 = wd.openDataRegion("Paragraph3");
...
aceCtrl1.openDocument("doc/split.doc", OpenModeType.docSubmitForm, "John Scott");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Split word document</em></strong></span></div>
...
as three single documents (Paragraph1.doc, Paragraph2.doc, Paragraph3.doc) to "wordSplit/doc" folder on server disk.<br/>
Only the Ultimate edition of Aceoffix supports Word document splitting,<br/>
 and the OpenModeType of the AceoffixCtrl must be OpenModeType.docSubmitForm.<br/>
  The property of DataRegion shall be set as dataRegion1.setSubmitAsFile(true);.<br/>
