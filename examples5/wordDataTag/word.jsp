...
<%
	...
	DataTag name=doc.openDataTag("{name}");
	name.setValue("Tom");
	DataTag number=doc.openDataTag("{number}");
	number.setValue("201501");
	DataTag department=doc.openDataTag("{department}");
	department.setValue("Development");
	DataTag manager=doc.openDataTag("{manager}");
	manager.setValue("John Scott");
	DataTag salary=doc.openDataTag("{salary}");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use DataTag to fill text data in Word document</em></strong></span></div>
        <div class="right">
