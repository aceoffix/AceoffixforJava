...
<%
        ...
        aceCtrl.addCustomToolButton("Define DataRegion", "ShowDefineDataRegions()", 3);
...
<title>Acesoft Corporation - Users define the location of DataRegion in the template</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Users define the location of DataRegion in the template</em></strong></span></div>
        <div class="right">
	...
	<div class="container left" style="color: black; font-size:20px;">
