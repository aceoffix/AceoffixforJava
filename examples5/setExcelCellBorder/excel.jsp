...
<%
	...
	Border B13Border = sheet.openTable("B13:B15").getBorder();
	B13Border.setWeight(XlBorderWeight.xlThin);
	B13Border.setLineColor(Color.blue);
	B13Border.setBorderType(XlBorderType.xlAllEdges);

	
	Border B6Border = sheet.openTable("B6:B8").getBorder();
	B6Border.setWeight(XlBorderWeight.xlThick);
	B6Border.setLineColor(Color.green);
	B6Border.setLineStyle(XlBorderLineStyle.xlSlantDashDot);
	B6Border.setBorderType(XlBorderType.xlAllEdges);
	
	Border B9Border = sheet.openTable("B9:B12").getBorder();
	B9Border.setWeight(XlBorderWeight.xlThick);
	B9Border.setLineColor(Color.DARK_GRAY);
	B9Border.setLineStyle(XlBorderLineStyle.xlSlantDashDot);
	B9Border.setBorderType(XlBorderType.xlAllEdges);
	
	
	Table titleTable = sheet.openTable("B4:D5");
	titleTable.getBorder().setWeight(XlBorderWeight.xlThick);
	titleTable.getBorder().setLineColor(new Color(255, 0, 0));
	titleTable.getBorder().setBorderType(XlBorderType.xlAllEdges);

	
	Table bodyTable2 = sheet.openTable("B6:D21");
	bodyTable2.getBorder().setWeight(XlBorderWeight.xlThick);
	bodyTable2.getBorder().setLineColor(new Color(255, 0, 0));
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Draw table line in Excel by programming</em></strong></span></div>
