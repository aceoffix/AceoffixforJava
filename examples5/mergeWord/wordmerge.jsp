...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Merge word document</em></strong></span></div>
...
<!--************** End of AceoffixCtrl JavaScript ************************-->	
	Key Code:<br/>
 DataRegion data1=doc.openDataRegion("Paragraph1");<br/>
data1.setValue("[word]doc/paragraph1.doc[/word]");<br/>
