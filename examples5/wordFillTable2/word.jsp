...
<%
	...
	Table table1=doc.openDataRegion("Table1").openTable(1);
	table1.openCellRC(1,1).setValue("Aceoffix");
...
<title>Acesoft Corporation - Insert new rows in the Table in Word document and assign the new Table</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Insert new rows in the Table in Word document and assign the new Table</em></strong></span></div>
        <div class="right">
