<%@ page language="java" import="java.util.*, com.acesoft.aceoffix.*" pageEncoding="UTF-8"%>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Different users can simultaneously modify different regions in one Excel document</em></strong></span></div>
...
<div id="inner-wrap" class="clearfix">
 ...
 Pass the parameters to the page opened by AceoffixLink.
 1. <a href="<%=AceoffixLink.openWindow(request,"wordquerystring.jsp?id=123","width=1000px;height=800px;")%>">Pass the query string at the server-side. </a>
 2. Pass the query string at the client-side. Select one item
 3. Pass the parameter by session.
 <br />
 Get the result from the page opened by AceoffixLink.
 1. Get the value and set it on the parent page.
