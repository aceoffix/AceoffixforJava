...
<%@ taglib uri="http://java.aceoffix.com" prefix="ace" %>
<%
	String strID=request.getParameter("id");
	if((strID!=null)&&(strID.length()>0)){
		String strFileName = "introduce.doc";//We assume that the strFileName value is returned through querying database by strID.
		AceoffixCtrl aceCtrl = new AceoffixCtrl(request);
		aceCtrl.setServerPage("../server.ace");//Required
		aceCtrl.setTheme(ThemeType.Office2007);
		aceCtrl.setSaveFilePage("savefilequerystring.jsp?id="+strID); //Pass the id parameter to savefile page.
		aceCtrl.addCustomToolButton("Save", "SaveDocument()", 1);
		aceCtrl.setJsFunction_AfterDocumentOpened("AfterDocumentOpened()"); 
		aceCtrl.openDocument("doc/"+strFileName, OpenModeType.docNormalEdit, "Tom");
		aceCtrl.setTagId("AceoffixCtrl1"); //Required 
	}
	else
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use AcoeffixLink to open document online</em></strong></span></div>
        <div class="right">
...
<p style=" text-indent:10px;" >
       AceoffixLink is a new method to open a document. This method has solved cross-browser compatibility issues perfectly.
        ...
        <p style=" text-indent:10px;" >
          ...
          The code to open hyperlink of the document in an usual way: &lt;a href=&quot;Word.jsp?id=12&quot;&gt;Document name-12&lt;a&gt;</p>
        <p style=" text-indent:10px;" >
           The code to open hyperlink of the document with AceoffixLink:
       &lt;a href=&quot;<span style=" background-color:#D2E9FF;">&lt;%=AceoffixLink.openWindow(request, &quot;</span>Word.jsp?id=12<span style=" background-color:#D2E9FF;">&quot;,&quot;width=800px;height=800px;&quot;)%&gt;</span>&quot;&gt;
  ...
  <div style="width:auto; height:600px;">
      <ace:AceoffixCtrl id="AceoffixCtrl1" />
  </div>
