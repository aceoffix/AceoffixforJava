...
<%
	...
	Table table1 = doc.openDataRegion("Table1").createTable(3,5,WdAutoFitBehavior.wdAutoFitWindow);
        ...
        table1.openCellRC(1,1).setValue("The merged cells");
	...
	DataRegion drTable2= doc.createDataRegion("Table2", DataRegionInsertType.After, "Table1");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Dynamically create tables in Word and assign them</em></strong></span></div>
