...
aceCtrl1.openDocument("../doc/editppt.ppt", OpenModeType.pptNormalEdit, "John Scott");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Edit PowerPoint document online</em></strong></span></div>
        <div class="right">
...
<script language="javascript" type="text/javascript">
	...
	function SaveAsHTML() {
	    ...
	    window.location = "viewhtml.jsp?mht=../doc/editppt.htm";
	}
