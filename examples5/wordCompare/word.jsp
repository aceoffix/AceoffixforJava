...
<%
	...
	aceCtrl.addCustomToolButton("Show Document A", "ShowFile1View()", 0);
	aceCtrl.addCustomToolButton("Show Document B", "ShowFile2View()", 0);
	aceCtrl.addCustomToolButton("Show comparison results", "ShowCompareView()", 0);
	aceCtrl.setOfficeToolbars(false);
	aceCtrl.setMenubar(false);
	aceCtrl.wordCompare("doc/introduce1.doc", "doc/introduce2.doc", OpenModeType.docFinalizeDraft, "Tom");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Compare two Word documents online</em></strong></span></div>
