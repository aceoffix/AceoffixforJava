...
<%
	...
	Table table=doc.openDataRegion("Table1").openTable(1);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Merge cells in the table in Word document by programming and set the style of the text in cell</em></strong></span></div>
        <div class="right">
