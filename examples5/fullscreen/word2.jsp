...
<%
	...
	aceCtrl.addCustomToolButton("Full-screen Switch", "SwitchFullScreen()", 4);
	aceCtrl.addCustomToolButton("-", "", 0);
...
<div id="banner-wrap" class="clearfix">
    ...
    <div id="nav-wrap" class="clearfix">
        <div class="container">
            <div id="logo" class="grid_3 alpha"><a href="http://www.aceoffix.com"><img src="../image/aceoffice.svg" height="" width="" alt="Aceoffix" class="scale-with-grid" ></a></div>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>How to open document with full screen window</em></strong></span></div>
        <div class="right">
            <a href="../index.jsp" >Example Center</a>
        </div>
        <div class="clear"></div>
    </div>
...
<a href="http://www.aceoffix.com/index.php/sitemap/">Sitemap</a>
		<br>
			&copy; 2017 Acesoft Corporation. All rights reserved.
    </div>
</div>
