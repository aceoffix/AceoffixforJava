...
<%
	...
	aceCtrl.getRibbonBar().setTabVisible("TabHome",true);//Home
	aceCtrl.getRibbonBar().setTabVisible("TabPageLayoutWord", false);//Page Layout
	aceCtrl.getRibbonBar().setTabVisible("TabReferences", false);//References
	aceCtrl.getRibbonBar().setTabVisible("TabMailings", false);//Mailings
	aceCtrl.getRibbonBar().setTabVisible("TabReviewWord", false);//Review
	aceCtrl.getRibbonBar().setTabVisible("TabInsert", false);//Insert
	aceCtrl.getRibbonBar().setTabVisible("TabView", false);//View

	aceCtrl.getRibbonBar().setSharedVisible("FileSave", false);//Office save button
	aceCtrl.getRibbonBar().setGroupVisible("GroupClipboard", false);//Clipboard
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Control the Ribbon bar of Word</em></strong></span></div>
...
Key code:aceCtrl.getRibbonBar().setTabVisible("TabHome",false);// use this code to hide the "Home" functional area in the Ribbon bar. ("TabHome" is the name of the functional area; "false" to hide, "true" to show.)<br/>
 aceCtrl.getRibbonBar().setSharedVisible("FileSave", false); //use this code to hide the "Save" button in Quick Access Toolbar. ("FileSave" is the button name; "false" to hide, "true" to show.)<br/>
 aceCtrl.getRibbonBar().setGroupVisible("GroupClipboard", false);//use this code to hide "Clipboard" in "Home" functional area. ("GroupClipboard" is the name of the panel; "false" to hide, "true" to show.)<br/>
