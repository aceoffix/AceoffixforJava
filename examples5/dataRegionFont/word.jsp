...
<%
	...
	DataRegion paragraph1 = doc.openDataRegion("Paragraph1");
	paragraph1.getFont().setColor(Color.BLUE);//Font Color
	paragraph1.getFont().setName("Arial Rounded MT Bold");// Font Style
	paragraph1.getFont().setSize(16);//Font Size
	paragraph1.getParagraphFormat().setAlignment(
			WdParagraphAlignment.wdAlignParagraphCenter);//Alignment

	DataRegion paragraph2 = doc.openDataRegion("Paragraph2");
	paragraph2.getFont().setColor(Color.orange);//Font Color
	paragraph2.getFont().setName("Algerian");//Font Style
	paragraph2.getFont().setSize(14);//Font Size
	paragraph2.getParagraphFormat().setAlignment(
			WdParagraphAlignment.wdAlignParagraphLeft);//Alignment

	DataRegion paragraph3 = doc.openDataRegion("Paragraph3");
	paragraph3.getFont().setColor(Color.magenta);//Font Color
	paragraph3.getFont().setName("Blackadder ITC");//Font Style
	paragraph3.getFont().setSize(12);//Font Size
	paragraph3.getParagraphFormat().setAlignment(
			WdParagraphAlignment.wdAlignParagraphRight);//Alignment
	
	
	aceCtrl.bind(doc);
	
	aceCtrl.openDocument("doc/introduce.doc",OpenModeType.docReadOnly,"Tom");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Set font of the text in DataRegion</em></strong></span></div>
        <div class="right">
...
<a href="word2.jsp" target="_blank">Please click and check the original document.</a><br /><br />
