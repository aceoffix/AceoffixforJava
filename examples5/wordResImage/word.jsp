...
<%
	...
	DataRegion image1=doc.openDataRegion("Image1");
	image1.setValue("[image]doc/image1.png[/image]");
	DataRegion image2=doc.openDataRegion("Image2");
	image2.setValue("[image]doc/image2.jpg[/image]");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use code to insert images in DataRegion</em></strong></span></div>
        <div class="right">
	...
	<div class="container left">
Key code:DataRegion image1=doc.openDataRegion("Image1");// The parameter of openDataRegion is the name of bookmark.<br/> 
		image1.setValue("[image]doc/image1.png[/image]");
