...
<%
	...
	aceCtrl.getRibbonBar().setTabVisible("TabFormulas", false);//Formulas
	aceCtrl.getRibbonBar().setTabVisible("TabInsert", false);//Insert
	aceCtrl.getRibbonBar().setTabVisible("TabData", false);//Data
	aceCtrl.getRibbonBar().setTabVisible("TabReview", false);//Review
	aceCtrl.getRibbonBar().setTabVisible("TabView", false);//View
	aceCtrl.getRibbonBar().setTabVisible("TabPageLayoutExcel", false);//PageLayout

aceCtrl.getRibbonBar().setSharedVisible("FileSave", false);//Office Save
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Control the Ribbon bar in Excel</em></strong></span></div>
