...
<%
	...
	DataRegion data1=doc.openDataRegion("Name");
	data1.setValue("Tom");
    data1.getFont().setColor(Color.blue);
    data1.getFont().setSize(24);
    data1.getFont().setName("Berlin Sans FB Demi");
    data1.getFont().setBold(true);
    
	DataRegion data2 = doc.openDataRegion("Department");
	data2.setValue("Sales Department");
	data2.getFont().setColor(Color.red);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Assign the DataRegion in Word and set style for it</em></strong></span></div>
        <div class="right">
