...
aceCtrl1.addCustomToolButton("Show/Hide Revisions", "ShowRevisions()", 0);
aceCtrl1.addCustomToolButton("Accept All Revisions", "AcceptAllRevisions()", 5);
aceCtrl1.addCustomToolButton("-", "", 0);
aceCtrl1.addCustomToolButton("Print", "ShowPrintDlg()", 6);

if ((strUserName != null) && (strUserName.length() > 0)){
    aceCtrl1.setSaveFilePage("savefile.jsp");
    aceCtrl1.openDocument("../doc/wordrevision.doc", OpenModeType.docFinalizeDraft, strUserName);
}
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Check and clean up all the revisions</em></strong></span></div>
        <div class="right">
