...
if ((strUserName != null) && (strUserName.length() > 0)){
	...
	if (strUserName.equals("John")){
	    wd.openDataRegion("title").setEditing(true); // ACE_title
	    wd.openDataRegion("firstpara").setEditing(true); // ACE_firstpara
	}
	else if (strUserName.equals("Mike")){
	    wd.openDataRegion("func1").setEditing(true); // ACE_func1
	    wd.openDataRegion("func2").setEditing(true); // ACE_func2
	    wd.openDataRegion("lastpara").setEditing(true); // ACE_lastpara
	}
    aceCtrl1.bind(wd);
    aceCtrl1.setSaveFilePage("savefile.jsp");
    aceCtrl1.openDocument("../doc/editableregions.doc", OpenModeType.docSubmitForm, strUserName);
}
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Editable Regions Control</em></strong></span></div>
        <div class="right">
