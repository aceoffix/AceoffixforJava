...
aceCtrl1.addCustomToolButton("Open Local", "OpenlocalDlg()", 0);

aceCtrl1.setSaveFilePage("saveuploaddoc.jsp");
aceCtrl1.createNewDocument("Jack", DocumentVersion.Word2003);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use JavaScript to open a document online</em></strong></span></div>
        <div class="right">
...
<script language="javascript" type="text/javascript">
    ...
    function Button1_onclick() {
        ...
        AceoffixCtrl1.Close();
        AceoffixCtrl1.SaveFilePage = "saveuploaddoc.jsp";
