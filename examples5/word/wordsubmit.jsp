...
aceCtrl1.setTheme(ThemeType.Office2007);
aceCtrl1.setBorderStyle(BorderStyleType.BorderThin);

WordDocument wd = new WordDocument();
wd.openDataRegion("EmployeeName").setEditing(true);
wd.openDataRegion("EmployeeNumber").setEditing(true);
wd.openDataRegion("Department").setEditing(true);
wd.openDataRegion("Manager").setEditing(true);

Calendar cal = Calendar.getInstance();
cal.add(Calendar.DATE, 2);
wd.openDataRegion("FromDate").setValue(cal.getTime().toString());
wd.openDataRegion("FromDate").setEditing(true);
wd.openDataRegion("ToDate").setValue(cal.getTime().toString());
wd.openDataRegion("ToDate").setEditing(true);

wd.openDataRegion("Reason").setEditing(true);
...
aceCtrl1.setCaption("Word document used as an input form.");
aceCtrl1.setSaveDataPage("saveworddata.jsp");
aceCtrl1.bind(wd);      
aceCtrl1.openDocument("../doc/doc-submit.doc", OpenModeType.docSubmitForm, "John Scott");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Word document used as an input form</em></strong></span></div>
        <div class="right">
