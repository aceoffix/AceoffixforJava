...
wd.setDisableWindowSelection(true); // Disabled Selection and Drag.
aceCtrl1.setCaption("Work Mode: Read Only; [Disabled Edit, Copy, Paste, Save as, Download, PrintScreen, F12, Context Menu, Print and etc.]");
aceCtrl1.setCustomToolbar(false);
aceCtrl1.setJsFunction_AfterDocumentOpened("OnAfterDocumentOpened()");
aceCtrl1.setAllowCopy(false); // Disabled Copy, PrintScreen, F12, Context Menu and etc.
aceCtrl1.bind(wd);      
aceCtrl1.openDocument("../doc/viewword.doc", OpenModeType.docReadOnly, "John Scott"); // docReadOnly: Disabled Edit, Paste.
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>View Word document in read-only mode</em></strong></span></div>
        <div class="right">
