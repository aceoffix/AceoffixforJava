...
<%
	...
	DataRegion dataRegion = doc.openDataRegion("ACE_Table");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Assign Table in Word document</em></strong></span></div>
        <div class="right">
