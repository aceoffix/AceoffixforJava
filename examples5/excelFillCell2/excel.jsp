...
<%
	...
	Cell cellD2 = sheet.openCell("D2");
	cellD2.setValue("Sales Report (2015)");
	cellD2.setForeColor(Color.GREEN);

	Cell cellF14 = sheet.openCell("F14");
	cellF14.setValue("100%");
	cellF14.setForeColor(new Color(255,64,0));
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Assign the cells in Excel and set the text color</em></strong></span></div>
