...
DataRegion data1=wd.createDataRegion("Paragraph1",DataRegionInsertType.After,"[home]");
data1.setValue("[word]doc/paragraph1.doc[/word]\r\n");
DataRegion data2=wd.createDataRegion("Paragraph2",DataRegionInsertType.After,"Paragraph1");
data2.setValue("[word]doc/paragraph2.doc[/word]\r\n");
DataRegion data3=wd.createDataRegion("Paragraph3",DataRegionInsertType.After,"Paragraph2");
data3.setValue("[word]doc/paragraph3.doc[/word]\r\n");

aceCtrl.bind(wd);
aceCtrl.setSaveFilePage("savefile.jsp");

aceCtrl.openDocument("doc/merge.doc",OpenModeType.docNormalEdit, "John Scott");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Create DataRegion</em></strong></span></div>
...
<div class="container left">
 Key Code:<br/>
  DataRegion data1=wd.createDataRegion("Paragraph1",DataRegionInsertType.After,"[home]");<br/>
