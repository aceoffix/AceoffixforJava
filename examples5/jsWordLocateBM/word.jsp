...
<%
	...
	aceCtrl.addCustomToolButton("Locate Bookmark","locateBookMark()",5);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Locate the cursor to where the bookmark is</em></strong></span></div>
...
<!--************** End of AceoffixCtrl JavaScript ************************-->    
 ...
 <br><!--************** End of AceoffixCtrl JavaScript ************************-->
