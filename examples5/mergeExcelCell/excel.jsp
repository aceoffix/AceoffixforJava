...
<%
	...
	cB2.setValue("Products for Sale");
	...
	cB4.setValue("Product A:");
	cB4.setForeColor(Color.red);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Merge cells in Excel document by programming; assign the new merged cell and set its format</em></strong></span></div>
