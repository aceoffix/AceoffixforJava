...
<%
	...
	aceCtrl.openDocument("doc/"+request.getParameter("filename"), OpenModeType.docNormalEdit, "Tom");
...
<!--************** End of AceoffixCtrl JavaScript ************************-->
    ...
    <div id="content">
        <div id="textcontent" style="width: 1000px; height: 800px;">
            <div class="flow4">
                <strong>Subject:</strong> <span style="color: Red;">
                        <%=new String(request.getParameter("subject").getBytes("UTF-8"),"UTF-8") %></span> <span style="width: 100px;">
                        </span>
            </div>
