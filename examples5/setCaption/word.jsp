...
<%
	...
	aceCtrl.setCaption("This content is controlled by Caption property of AceoffixCtrl and can be set as any text you want.");
...
<title>Acesoft Corporation - Modify caption of Aceoffix control</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Modify caption of Aceoffix control</em></strong></span></div>
        <div class="right">
...
Key code:aceCtrl.setCaption("This content is controlled by Caption property of AceoffixCtrl and can be set as any text you want."); <br/>
