...
sheet1.openCell("D8").setValue("XYZ-11-" + String.valueOf(10001 + rd.nextInt(10000)));
sheet1.openCell("D8").setReadOnly(true);

Cell cellDate = sheet1.openCell("I6");
Date dt = new Date();
cellDate.setValue(dt.toString());
sheet1.openCell("J31").setValue(dt.toString());
...
aceCtrl1.setCaption("Excel spreadsheet used as an input form.");
aceCtrl1.bind(wb);
aceCtrl1.setSaveDataPage("saveexceldata.jsp"); 
aceCtrl1.openDocument("../doc/xls-submit.xls", OpenModeType.xlsSubmitForm, "John Scott"); // docReadOnly: Disabled Edit, Paste.
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Excel spreadsheet used as an input form</em></strong></span></div>
        <div class="right">
