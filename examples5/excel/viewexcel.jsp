...
wb.setDisableSheetSelection(true);
aceCtrl1.setCaption("Work Mode: Read Only; [Disabled Edit, Copy, Paste, Save as, Download, PrintScreen, F12, Context Menu and etc.]");

// Create custom toolbar
aceCtrl1.addCustomToolButton("Page Setup", "ShowPageSetup()", 0);
...
aceCtrl1.bind(wb);      
aceCtrl1.openDocument("../doc/viewexcel.xls", OpenModeType.xlsReadOnly, "John Scott"); // docReadOnly: Disabled Edit, Paste.
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>View Excel document in read-only mode</em></strong></span></div>
        <div class="right">
