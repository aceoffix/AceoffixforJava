...
aceCtrl1.addCustomMenuItem("Show &caption of titlebar", "OnCustomMenuClick()", true);
aceCtrl1.addCustomMenuItem("-", "", true);
aceCtrl1.addCustomMenuItem("Save As HTML to Web Server", "OnCustomMenuClick()", true);

// Create custom toolbar
aceCtrl1.addCustomToolButton("Save", "SaveDocument()", 1);
aceCtrl1.addCustomToolButton("-", "", 0);
aceCtrl1.addCustomToolButton("Page Setup", "ShowPageSetupDlg()", 8);
aceCtrl1.addCustomToolButton("Print", "ShowPrintDlg()", 6);
aceCtrl1.addCustomToolButton("-", "", 0);
aceCtrl1.addCustomToolButton("Save As HTML", "SaveAsHTML()", 0);
aceCtrl1.addCustomToolButton("-", "", 0);
...
aceCtrl1.openDocument("../doc/editexcel.xls", OpenModeType.xlsNormalEdit, "John Scott");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Edit Excel document online</em></strong></span></div>
        <div class="right">
...
<script language="javascript" type="text/javascript">
	...
	function SaveAsHTML() {
	    ...
	    window.location = "viewhtml.jsp?mht=../doc/editexcel.htm";
	}
