...
aceCtrl1.addCustomToolButton("VBA: cell format", "CallVBA1()", 0);
aceCtrl1.addCustomToolButton("VBA: insert row", "CallVBA2()", 0);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use JavaScript to call VBA interface of Excel application</em></strong></span></div>
        <div class="right">
