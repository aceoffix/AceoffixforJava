...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Assign the cell with defined name in the Excel template</em></strong></span></div>
...
<div class="container left">
 ...
 Cells B1, F14 are filled with data by programming.  Please check the code of excel.jsp.
