...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Return the value of saving results customized by developer to front page after saving the document.</em></strong></span></div>
        <div class="right">
...
Key code: right click; choose "view source" and refer to the JavaScript function "SaveDocument()":<br/>
   ...
   Set the server code freq.setCustomSaveResult("OK"); in savefile.jsp. Developer can define the this value freely.<br/>
