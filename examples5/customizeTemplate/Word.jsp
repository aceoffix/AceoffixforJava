...
<%
        ...
        doc.openDataRegion("DATE").setValue("03/06/2013");        
        doc.openDataRegion("Payment").setValue("First Data");  
        doc.openDataRegion("Number").setValue("************9355");  
        doc.openDataRegion("Status").setValue("Validated (no renewal)");  
        doc.openDataRegion("Name").setValue("Tom");  
        doc.openDataRegion("Add").setValue("XX East XXth Street XXth floor New York NY 10006 USA");
        doc.openDataRegion("Tel").setValue("+1(888)88882222");
        doc.openDataRegion("Email").setValue("XXXx@XXXX.com");

        doc.openDataTag("{Date}").setValue("03/10/2013"); 
        ...
        if ("1".equals(type))
        {
            aceCtrl.addCustomToolButton("Save", "Save2()", 1);
        ...
        {
            aceCtrl.setMenubar(true);
            aceCtrl.setCustomToolbar(false);
            aceCtrl.setOfficeToolbars(false);
            aceCtrl.openDocument("doc/test.doc", OpenModeType.docReadOnly, "Tom");
        }
        else if ("3".equals(type))
        {
            ...
            aceCtrl.setOfficeToolbars(false);
            aceCtrl.openDocument("doc/test.doc", OpenModeType.docSubmitForm, "Tom");
        }
