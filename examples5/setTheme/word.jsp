...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Set UI theme of Aceoffix</em></strong></span></div>
        <div class="right">
 ...
 Operation: Set Theme property of AceoffixCtrl in server code.<br/>
   Key Code: AceoffixCtrl.setTheme (ThemeType.Office2007); //ThemeType is the enumeration type. The current theme is that of Office2007.
