...
<%@page import="com.acesoft.aceoffix.*,com.acesoft.aceoffix.excelwriter.*,java.text.*,java.awt.*"%>
...
<%
        ...
        aceCtrl.addCustomToolButton("Save","Save()",0);
...
<div class="container left">
					<strong>User:</strong>
					<span style="color: Red;"><%=strInfo %> [Only the yellow region can be edited.]</span>				
