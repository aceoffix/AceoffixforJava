...
<div id="inner-wrap" class="clearfix">
 ...
 <form id="form1"  action="excel.jsp" method="post"> 
    ...
    <input type="button"  value="Open file" onclick="javascript:AceBrowser.openWindowModeless('excel.jsp?userName='+form1.userName.value,'width=1200px;height=800px;');" /><br /><br />
