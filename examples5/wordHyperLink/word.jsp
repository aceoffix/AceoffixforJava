...
<%
	...
	aceCtrl.addCustomToolButton("Hyperlink","addHyperLink()",5);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Insert Hyperlink in Word document</em></strong></span></div>
