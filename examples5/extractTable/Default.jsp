...
<%
        ...
        DataRegion dTable = doc.openDataRegion("table");
        
        dTable.setEditing(true);

        
        Table table1 = doc.openDataRegion("Table").openTable(1);
        ...
        aceCtrl.addCustomToolButton("Full-screen Switch", "IsFullScreen", 4);
        aceCtrl.bind(doc);
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Get the data from the Table in Word document</em></strong></span></div>
        <div class="right">
