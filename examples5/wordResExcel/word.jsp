...
<%
	...
	DataRegion image=doc.openDataRegion("Image");
	image.setValue("[image]doc/image1.png[/image]");
	DataRegion excel=doc.openDataRegion("Excel");
	excel.setValue("[excel]doc/excel.xls[/excel]");
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use code to insert Excel documents in DataRegion</em></strong></span></div>
        <div class="right">
...
Key code:DataRegion excel=doc.openDataRegion("Excel");// The parameter of openDataRegion is the name of bookmark. <br/> 
excel.setValue("[excel]doc/excel.xls[/excel]");
