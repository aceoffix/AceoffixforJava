...
<%
    ...
    doc.getTemplate().defineDataTag("[CONTRACT NO]");
	doc.getTemplate().defineDataTag("[DATA]");
    doc.getTemplate().defineDataTag("[THE BUYER]");
	doc.getTemplate().defineDataTag("[Add]");
	doc.getTemplate().defineDataTag("{Add}");
	doc.getTemplate().defineDataTag("[Tel]");
	doc.getTemplate().defineDataTag("[THE SELLER]");
	doc.getTemplate().defineDataTag("[Name]");
	doc.getTemplate().defineDataTag("[Signature]");
	...
	aceCtrl.addCustomToolButton("Save", "SaveDocument()", 1);
	 aceCtrl.addCustomToolButton("Define DataTags", "ShowDefineDataTags()", 3);
...
<title>Acesoft Corporation - Users define the location of DataTag in the template</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../index.jsp" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Users define the location of DataTag in the template</em></strong></span></div>
        <div class="right">
